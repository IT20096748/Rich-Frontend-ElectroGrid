...
public class ComplaintAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		String output = complaintObj.insertComplaint(request.getParameter("cID"), request.getParameter("type"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response)
		...
		String output = complaintObj.updateComplaint(paras.get("hidItemIDSave").toString(),
				paras.get("type").toString(), paras.get("cdesc").toString());
