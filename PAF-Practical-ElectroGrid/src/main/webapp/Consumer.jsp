...
<body>
	...
	<br>
	<h1 class="text-white text-center mt-5">Consumer Registration Form</h1>
	<br>
	...
	<div class="container ">
		<div class="row">
			...
			<div class="mx-auto float-left col-10" style="width: 30%;">
				<img src="Images/elec.png" alt="ceb" hieght="350" width="350"
				...
				<form id="formItem" name="formItem"
					...
					<div class="input-group mb-3 ">
						...
						<input id="accountNo" name="accountNo" type="number"
							class="form-control" placeholder="Enter account number Here"
							required>
			...
			<div id="divItemsGrid"
				...
				<%
				Consumer ConsumerAPIObj = new Consumer();
				out.print(ConsumerAPIObj.readconsumer());
				%>
